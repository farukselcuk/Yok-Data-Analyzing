                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="../../assets/images/users/3.jpg" alt="user" width="50"
                                            class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium">Johnathan Doeting</h6>
                                        <span class="mb-3 d-block">Lorem Ipsum is simply dummy text of the printing
                        ...
                        <div id="accordian-4">
                            <div class="card mt-4">
                                ...
                                <a class="card-header link collapsed border-top" data-toggle="collapse"
                        ...
                        <div class="card">
                            ...
                            <ul class="list-style-none">
                                <li class="card-body">
                                    <a href="#" class="mb-0 p-0">
                                        <div class="d-flex no-block">
                                            <i class="fa fa-check-circle w-30px mt-1"></i>
                                            <div>
                                                <span class="font-bold">Themeforest</span> Approved My college <span
                                                    class="font-bold">1 user</span>
                                ...
                                <li class="card-body border-top">
                                    <a href="#" class="mb-0 p-0">
                                        <div class="d-flex no-block">
                                            <i class="fa fa-user w-30px mt-1"></i>
                                            <div>
